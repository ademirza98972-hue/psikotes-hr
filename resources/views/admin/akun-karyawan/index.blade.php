...
<div x-data="{ modalHapus: false, idHapus: null, namaHapus: '' }">
    ...
    {{-- FILTER BAR --}}
    <form method="GET" action="{{ route('admin.akun-karyawan.index') }}" class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <thead style="position: sticky; top: 0; z-index: 5;">
                    <tr style="background: #0f2230; border-bottom: 1px solid #0a1a25;">
                        ...
                        <th class="px-6 py-4 text-[11px] font-bold uppercase tracking-wider" style="color: #7db8c2;">Posisi</th>
                        <th class="px-6 py-4 text-[11px] font-bold uppercase tracking-wider text-center" style="color: #7db8c2;">Status Akun</th>
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-14 text-center">
                                @if($kataKunci || $filterDepartemen || $filterPosisi)
                                    ...
                                    <a href="{{ route('admin.akun-karyawan.index') }}" class="inline-flex items-center gap-2 rounded-xl border border-[#c0c8cb] px-4 py-2 text-sm font-medium text-[#40484b] hover:bg-[#f2f4f6] transition-colors">
                                        <span class="material-symbols-outlined text-[16px]">close</span>
                                        Reset Filter
                                    </a>
                                @else
                                    <span class="material-symbols-outlined block mb-3" style="font-size:40px; color:#c0c8cb;">group</span>
                                    <p class="text-[14px] font-medium text-[#40484b] mb-1">Belum Ada Akun Karyawan</p>
                                    <p class="text-[12px] text-[#71787c] mb-4">Tambahkan akun karyawan untuk mulai mengelola data.</p>
                                    @auth
                                        @if(auth()->user()->hasIzin('pengguna.tambah'))
                                            <a href="{{ route('admin.akun-karyawan.tambah') }}" class="inline-flex items-center gap-2 rounded-xl bg-[#2C5F6F] px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#1E414C] transition-all active:scale-95">
