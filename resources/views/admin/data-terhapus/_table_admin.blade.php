            ...
            <tbody class="divide-y divide-slate-100">
                @forelse ($items as $item)
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-3 text-slate-600">{{ $item->peran?->nama_peran ?? '-' }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-4 py-10 text-center text-sm text-slate-500">Tidak ada akun admin/staff yang dihapus.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
