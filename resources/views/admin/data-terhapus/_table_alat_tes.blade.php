            ...
            <table class="w-full text-left border-collapse">
                <thead style="position: sticky; top: 0; z-index: 5;">
                    <tr style="background: #0f2230; border-bottom: 1px solid #0a1a25;">
                        ...
                        <th class="px-6 py-4 text-[11px] font-bold uppercase tracking-wider" style="color: #7db8c2;">Kode</th>
                        <th class="px-6 py-4 text-[11px] font-bold uppercase tracking-wider" style="color: #7db8c2;">Nama Alat Tes</th>
                        <th class="px-6 py-4 text-[11px] font-bold uppercase tracking-wider" style="color: #7db8c2;">Format Dasar</th>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-14 text-center">
                                ...
                                <p class="text-[12px] text-[#71787c]">Tidak ada alat tes yang dihapus.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
