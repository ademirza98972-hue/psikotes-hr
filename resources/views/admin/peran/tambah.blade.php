...
<div class="w-full"
    ...
    <div class="mb-4 flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <span class="font-[18px] leading-[24px] font-semibold text-[#191c1e]">Tambah Peran Baru</span>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="2" maxlength="1000"
                          class="w-full rounded-xl border border-[#c0c8cb] bg-white focus:border-[#2C5F6F] focus:ring-[#2C5F6F] font-[14px] leading-[20px] text-[#191c1e] px-4 py-3 transition-all shadow-sm resize-none">{{ old('deskripsi') }}</textarea>
            </div>
        </div>
                        ...
                        <div id="{{ $prefixId }}" class="space-y-3">
                            @foreach ($daftar as $izin)
                                <label class="flex items-center gap-3 cursor-pointer select-none">
                                    ...
                                    <span class="font-[14px] leading-[20px] text-[#191c1e]">{{ $izin->deskripsi }}</span>
                                </label>
                            @endforeach
                        </div>
                    </div>
